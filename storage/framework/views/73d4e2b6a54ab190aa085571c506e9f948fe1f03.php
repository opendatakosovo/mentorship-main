                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[name]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.name'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[email]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.email'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[sex]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.sex'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[dob]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.dob'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[designation]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.designation'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[designation]')->raw(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[mobile]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.mobile'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[phone]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.phone'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[street]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.street'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[city]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.city'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[district]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.district'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[state]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.state'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[country]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.country'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[web]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.web'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[status]" class="col-sm-2 control-label">
                                        <?php echo trans('user::user.label.status'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[status]')->raw(); ?>
...
$(document).ready(function(){
    ...
    $(".user-user .btn-open").click(function(){
        ...
        return false;
        $('#open-list').load("<?php echo guard_url('/settings/setting/search/user.user.search'); ?>");
...
</script><?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/user/admin/user/partial/filter.blade.php ENDPATH**/ ?>