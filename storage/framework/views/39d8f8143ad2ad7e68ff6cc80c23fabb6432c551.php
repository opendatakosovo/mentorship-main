                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[name]" class="col-sm-2 control-label">
                                        <?php echo trans('roles::role.label.name'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[slug]" class="col-sm-2 control-label">
                                        <?php echo trans('roles::role.label.slug'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[level]" class="col-sm-2 control-label">
                                        <?php echo trans('roles::role.label.level'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[level]')->raw(); ?>
...
$(document).ready(function(){
    ...
    $(".roles-role .btn-open").click(function(){
        ...
        return false;
        $('#open-list').load("<?php echo guard_url('/settings/setting/search/roles.role.search'); ?>");
...
</script><?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/roles/admin/role/partial/filter.blade.php ENDPATH**/ ?>