                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[name]" class="col-sm-2 control-label">
                                        <?php echo trans('page::page.label.name'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[title]" class="col-sm-2 control-label">
                                        <?php echo trans('page::page.label.title'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[title]')->raw(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[compile]" class="col-sm-2 control-label">
                                        <?php echo trans('page::page.label.compile'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[compile]')->raw(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[order]" class="col-sm-2 control-label">
                                        <?php echo trans('page::page.label.order'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[order]')->raw(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[status]" class="col-sm-2 control-label">
                                        <?php echo trans('page::page.label.status'); ?>
...
$(document).ready(function(){
    ...
    $(".page-page .btn-open").click(function(){
        ...
        return false;
        $('#open-list').load("<?php echo guard_url('settings/setting/search/page.page.search'); ?>");
   ...
   $(".page-page .btn-search").click(function(){
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#page-page-list .btn-reset-filter').css('display', 'none');

    });

});
</script><?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/page/admin/page/partial/filter.blade.php ENDPATH**/ ?>