<div class="btn-group roles-permission">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[name]" class="col-sm-2 control-label">
                                        <?php echo trans('roles::permission.label.name'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[slug]" class="col-sm-2 control-label">
                                        <?php echo trans('roles::permission.label.slug'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[slug]')->raw(); ?>
...
$(document).ready(function(){
    ...
    $(".roles-permission .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("<?php echo guard_url('/settings/setting/search/roles.permission.search'); ?>");
        $('#modal-open').modal("show");
    });

   $(".roles-permission .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.roles-permission .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'roles.permission.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#roles-permission-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#roles-permission-list .btn-reset-filter').css('display', 'none');

    });

});
</script><?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/roles/admin/permission/partial/filter.blade.php ENDPATH**/ ?>