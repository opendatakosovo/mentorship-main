    ...
    <div id='user-client-entry'>
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                    ...
                    <li class="<?php echo (request('status') == 'archive')?'active':'';; ?>"><a href="<?php echo guard_url('user/client?status=archive'); ?>">Archived</a></li>
                    <li class="<?php echo (request('status') == 'deleted')?'active':'';; ?>"><a href="<?php echo guard_url('user/client?status=deleted'); ?>">Trashed</a></li>
                    <li class="pull-right">
                    <span class="actions">
                    <?php echo $__env->make('user::admin.default.partial.filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make('user::admin.default.partial.column', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </span>
                </li>
            </ul>
            <div class="tab-content">
                <table id="user-client-list" class="table table-striped data-table">
                    ...
                    <th data-field="sex"><?php echo trans('user::client.label.sex'); ?></th>
                    <th data-field="dob"><?php echo trans('user::client.label.dob'); ?></th>
                    <th data-field="mobile"><?php echo trans('user::client.label.mobile'); ?></th>
                    <th data-field="phone"><?php echo trans('user::client.label.phone'); ?></th>
                    <th data-field="address"><?php echo trans('user::client.label.address'); ?></th>
                    <th data-field="street"><?php echo trans('user::client.label.street'); ?></th>
                    <th data-field="city"><?php echo trans('user::client.label.city'); ?></th>
                    <th data-field="district"><?php echo trans('user::client.label.district'); ?></th>
                    <th data-field="state"><?php echo trans('user::client.label.state'); ?></th>
                    <th data-field="country"><?php echo trans('user::client.label.country'); ?></th>
                    <th data-field="photo"><?php echo trans('user::client.label.photo'); ?></th>
                    <th data-field="web"><?php echo trans('user::client.label.web'); ?></th>
                    </thead>
                </table>
            </div>
        </div>
...
</script><?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/user/admin/default/index.blade.php ENDPATH**/ ?>