              ...
              <div class='row'>
                <div class='col-md-12 col-sm-12'>
                       <div class="row">
                         <div class="col-md-8"> 
                           <?php echo Form::text('command[name]')
                         ...
                         <div class="col-md-4"> 
                           <?php echo Form::select('settings[theme]')
                       ...
                       <div class="row">
                         <div class="col-md-6"> 
                         <?php echo Form::text('settings[google.analytics]')
                         ...
                         <div class="col-md-6"> 
                         <?php echo Form::text('settings[google.recaptcha]')
                       ...
                       <div class="row">
                         ...
                         <div class="col-md-4"> 
                       <?php echo Form::select('settings[dateformat]')
                       ...
                       -> placeholder(trans('settings::setting.placeholder.dateformat')); ?>
                         ...
                         <div class="col-md-4"> 
                       <?php echo Form::select('settings[timeformat]')
                       ...
                       -> placeholder(trans('settings::setting.placeholder.timeformat')); ?>
                         ...
                         <div class="col-md-4"> 
                       <?php echo Form::select('settings[timezone]')
                      ...
                      <fieldset>
                        <legend><?php echo e(trans('settings::setting.label.currency.heading')); ?></legend>
                      <div class="row clearfix">

                        <div class="col-md-8">
                         <?php echo Form::select('settings[currency.currency]')
                        ...
                        <div class="col-md-4">
                         <?php echo Form::select('settings[currency.position]')
                        ...
                        <div class="col-md-4">
                         <?php echo Form::text('settings[currency.thousandseperator]')
                        ...
                        <div class="col-md-4">
                         <?php echo Form::text('settings[currency.decimalseperator]')
                        ...
                        <div class="col-md-4">
                         <?php echo Form::text('settings[currency.decimal]')
            ...
            <?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/settings/admin/setting/partial/main.blade.php ENDPATH**/ ?>