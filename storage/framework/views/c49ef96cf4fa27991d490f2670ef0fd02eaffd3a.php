    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content clearfix">
            ...
            <?php echo $__env->make('page::admin.page.partial.entry', ['mode' => 'show'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
<?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/page/admin/page/show.blade.php ENDPATH**/ ?>