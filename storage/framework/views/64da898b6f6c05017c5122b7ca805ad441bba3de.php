<div class="btn-group teams-team">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[name]" class="col-sm-2 control-label">
                                        <?php echo trans('user::team.label.name'); ?>
...
$(document).ready(function(){
    ...
    $(".teams-team .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("<?php echo guard_url('/settings/setting/search/teams.team.search'); ?>");
        $('#modal-open').modal("show");
    });

   $(".teams-team .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.teams-team .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'teams.team.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#teams-team-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#teams-team-list .btn-reset-filter').css('display', 'none');

    });

});
</script><?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/user/admin/team/partial/filter.blade.php ENDPATH**/ ?>