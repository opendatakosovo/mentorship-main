        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col3 manage-column">
                    ...
                    <?php echo Form::checkboxes('manage_columns')
                    ->checkboxes(trans('roles::permission.cloumns'))
                    ->inline()
                    ->raw(); ?>
...
<script type="text/javascript">
    ...
    $("#save_columns_settings").click(function(){
        ...
        formData.append('key', 'roles.permission.column');
        formData.append('package', 'Roles');
        formData.append('module', 'Permission');
...
</script><?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/roles/admin/permission/partial/column.blade.php ENDPATH**/ ?>