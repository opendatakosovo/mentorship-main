        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col3 manage-column">
                    ...
                    ->checkboxes(trans('user::team.cloumns'))
                    ->inline()
                    ->raw(); ?>
...
<script type="text/javascript">
    ...
    $("#save_columns_settings").click(function(){
        ...
        formData.append('key', 'teams.team.column');
        formData.append('package', 'Teams');
...
</script><?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/user/admin/team/partial/column.blade.php ENDPATH**/ ?>