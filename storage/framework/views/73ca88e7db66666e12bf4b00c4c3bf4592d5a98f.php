        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col3 manage-column">
                    ...
                    ->checkboxes(trans('roles::role.cloumns'))
                    ->inline()
                    ->raw(); ?>
...
<script type="text/javascript">
    ...
    $("#save_columns_settings").click(function(){
        ...
        formData.append('key', 'roles.role.column');
        formData.append('package', 'Roles');
        formData.append('module', 'Role');
...
</script><?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/roles/admin/role/partial/column.blade.php ENDPATH**/ ?>