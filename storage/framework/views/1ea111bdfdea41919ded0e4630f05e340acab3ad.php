    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            ...
            <div class="box-tools pull-right">
                <button type="button" class="btn btn-primary btn-sm" data-action='UPDATE' data-form='#user-client-edit'  data-load-to='#user-client-entry' data-datatable='#user-client-list'><i class="fa fa-floppy-o"></i> <?php echo e(trans('app.save')); ?></button>
        ...
        <div class="tab-content clearfix">
            <div class="tab-pane active" id="client">
                ...
                <?php echo $__env->make('user::default.partial.entry', ['mode' => 'edit'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
        <?php echo Form::close(); ?>

    </div><?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/user/admin/default/edit.blade.php ENDPATH**/ ?>