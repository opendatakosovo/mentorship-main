...
<div class="<?php echo e($field); ?>-file-cropper text-center">
    <img src='<?php echo url()->to(@$src); ?>' alt="" class="img-responsive" id="image-<?php echo e($field); ?>">
    <br/>
    <div class="btn-group">
    ...
    <button type="button" class="btn btn-primary" data-method="save" title="Destroy" id="<?php echo e($field); ?>-save-image">
...
</script><?php /**PATH C:\xampp\htdocs\lavalite\website\resources\views/vendor/filer/cropper.blade.php ENDPATH**/ ?>