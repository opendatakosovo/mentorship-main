            ...
            <div class="col-md-4">
                ...
                <div class="card bg-blue order-card">
                    <div class="card-block">
                        ...
                        <p class="mb-0">This month<span class="pull-right">351</span></p>
                    </div>
                </div>
                <!-- /.widget-user -->
            </div>
            ...
            <div class="col-md-4">
                <div class="card bg-pink order-card">
                    <div class="card-block">
                        ...
                        <h2 class="text-right"><i class="far fa-credit-card pull-left"></i><span>542</span></h2>
                        <p class="mb-0">This Year<span class="pull-right">9,562</span></p>
                    </div>
                </div>
            </div>
            <!-- /.col -->
