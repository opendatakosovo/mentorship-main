...
{{--As part of the second phase on becoming a mentor, you are expected to complete two online courses provided below and provide the certificates on your personal profile.--}}
{{--Online Courses:--}}
{{--<a href="https://agora.unicef.org/course/info.php?id=7380">Sexual Harassment</a>--}}
{{--<a href="https://agora.unicef.org/course/info.php?id=915">Child protection</a>--}}
{{--<br>--}}
{{--After completing the online courses, you will be offered a free of charge training on “Human Centered Design“ provided by certified trainers and financed by UNICEF Kosovo Program which you need to attend in order to complete your profile as a mentor of the Mentorship Scheme.--}}
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">We are delighted to inform you that your application has been accepted!</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="500" class="responsive-table">
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #333333;" class="padding-copy">Online Courses:</td>
                            </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 20px 0 40px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="center" style="padding: 15px 0 0 0; font-family: Arial, sans-serif; color: #333333; font-size: 20px;" bgcolor="#ffffff"><a href="https://agora.unicef.org/course/info.php?id=7380">Sexual Harassment</a></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <tr>
                                            <td style="padding: 20px 0 40px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="center" style="padding: 15px 0 0 0; font-family: Arial, sans-serif; color: #333333; font-size: 20px;" bgcolor="#ffffff"><a href="https://agora.unicef.org/course/info.php?id=915"> Child protection</a></td>
                                                    </tr>
