...
class ApplicationsController extends Controller
{
 ...
 public function update_client_file(Request $id)
 {
  foreach ($request->file('cv_upload_update') as $cv) {

   $filename = $cv->file('cv_upload_update')->store('cv/' . $request->email);
   //    $filename = $cv->store('certificates/' . $request->mentor_id);
   $filename = $cv->store('cv/' . $request->email);
