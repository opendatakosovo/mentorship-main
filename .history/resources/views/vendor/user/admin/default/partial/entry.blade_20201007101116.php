...
<div class="row">
    ...
    <div class="col-md-3 col-sm-6">
        <form action="update_client_file" method="POST">
...
<div id="myModal" class="modal">
    <div class="modal-content">
        ...
        <form action="/admin_update_cv" method="POST" accept-charset="utf-8" novalidate="novalidate"  enctype="multipart/form-data">
            @CSRF
            @method('POST')
            <input type="hidden" name="client_id" value={{$client->id}}>
            <p>Upload CV</p>
            <input accept="application/pdf" class="form-control valid" name="files" type="file">
