...
<div class="row">
    ...
    <div class="col-md-3 col-sm-6">
        ...
        <form action="admin/client/update_cv" method="POST">
            {{-- @CSRF --}}
            {{-- @method('PUT') --}}
               <label for="university" class="control-label">Upload your CV</label>
                <input type="hidden" name="mentor_id" value="{{ $client->id }}">
        <input type="file" class="form-control" id="cv_upload_update" name="cv_upload_update" required accept="application/pdf"
            onchange="validatePDF(this)" class="error"><br>
...
{{-- <div id="myModal" class="modal">
    <div class="modal-content">
        ...
        <form accept-charset="utf-8" novalidate="novalidate">
            @CSRF
            @method('PUT')
            <input name="client_id" value="{{ $client->id }}">
            <p>Upload CV</p>
            <input type="file" id="cv_upload_update" name="cv_upload_update">
