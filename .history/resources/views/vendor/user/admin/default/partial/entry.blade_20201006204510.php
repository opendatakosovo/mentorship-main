...
<div class="row">
    ...
    <div class="col-md-3 col-sm-6">
        <button id="myBtn" class="btn btn-primary btn-sm" type="button">Upload CV</button>
        {{-- <form action="admin/update_cv" method="POST">
            @CSRF
            @method('PUT')
               <label for="university" class="control-label">Upload your CV</label>
                <input type="hidden" name="mentor_id" value="{{ $client->id }}">
        <input type="file" class="form-control" id="cv_upload" name="cv_upload" required accept="application/pdf"
