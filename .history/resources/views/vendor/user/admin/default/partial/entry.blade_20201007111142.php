...
<div id="myModal" class="modal">
    <div class="modal-content">
        ...
        <form action="/admin_update_cv" method="GET" novalidate="novalidate" name="cv" enctype="multipart/form-data">
            @CSRF
            @method('PUT')
            <input type="hidden" name="client_id" value={{$client->id}}>
            <p>Upload CV</p>
            <input accept="application/pdf" class="form-control valid" name="cv" id="cv" type="file">
