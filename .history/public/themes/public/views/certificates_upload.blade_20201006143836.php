...
<head>
    ...
    <link rel="stylesheet"
        href="/themes/public/assets/maintheme/assets/vendors/font-awesome/css/font-awesome.min.css" />
                            ...
                            <div class="navbar-header">
                                <a class="navbar-brand" href="/" rel="home">
                                    <span class="navbar-brand-inner">
                                        <img class="logo-dark"
                                            src="themes/public/assets/maintheme/assets/img/logo/logo-1.svg"
                                        ...
                                        <img class="logo-default"
                                            src="/themes/public/assets/maintheme/assets/img/logo/logo-1-new.png"
                                            alt="Mentorship Platform">
                                    </span>
                                </a>
    ...
    <section class="vc_row pt-50 pb-60" id="apply" style="margin-top: 10%">
        <div class="container">
            <div class="row">
                ...
                <div class="lqd-column col-md-10 col-md-offset-1 text-center ca-initvalues-applied lqd-animations-done"
                    ...
                    <div class="form lqd-unit-animation-done" style="transform: translateY(0px); opacity: 1;">
                        ...
                        <form action="/user/application/store_certificates/upload" enctype="multipart/form-data"
                            method="post">
                            {{ csrf_field() }}
                            <input type="hidden" name="mentor_id" value="{{$data['mentor_id']}}">
                            <div class="form-group">
                                <input multiple="multiple" accept="application/pdf" class="form-control valid"
