                ...
                <div class="lqd-column col-md-10 col-md-offset-1 text-center" data-custom-animations="true"
                    ...
                    <form action="user/application/store" method="POST" enctype="multipart/form-data">
                        <div class="form">
                            ...
                            <div class="form-group">
                                <input  type="text" name="lastname" class="form-control valid"
                                    id="lastname" placeholder="Your Last Name" data-rule="minlen:4"
                                    data-msg="Please enter at least 4 chars" aria-invalid="false">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <input  type="email" class="form-control valid" name="email"
                            ...
                            <div class="form-group">
                                <select  class="form-control valid" id="city" name="city"
                                    required="">
