                    ...
                    <form action="user/application/store" method="POST" enctype="multipart/form-data">
                        <div class="form">
                            <div class="form-group">
                                ...
                                <input style="background:red" type="text" name="name" class="form-control valid" id="name"
                                       placeholder="Your Name" data-rule="minlen:4"
                                       data-msg="Please enter at least 4 chars" aria-invalid="false">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <input style="background:red" type="text" name="lastname" class="form-control valid" id="lastname"
                                       placeholder="Your Last Name" data-rule="minlen:4"
                                       data-msg="Please enter at least 4 chars" aria-invalid="false">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <input style="background:red" type="email" class="form-control valid" name="email" id="email"
                                       placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <select style="background:red" class="form-control valid" id="sex" name="sex" required="">
                            ...
                            <input style="background:red" type="hidden" name="dob" value="2014-05-15">
                            <div style="background:red" class="form-group">
                                <label>Contact Info</label>
                                <input style="background:red" type="text" class="form-control" name="mobile" id="mobile"
                                       placeholder="Mobile Phone" data-rule="minlen:4"
                                       data-msg="Please enter at least 8 chars of subject">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <input style="background:red" type="text" class="form-control" name="phone" id="phone" placeholder="Phone"
                                       data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <label>Where do you live ?</label>
                                <input style="background:red" type="text" class="form-control" name="address" id="address"
                                       placeholder="Address" data-rule="minlen:4"
                                       data-msg="Please enter at least 8 chars of subject">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <input style="background:red" type="text" class="form-control" name="street" id="street" placeholder="Street"
                                       data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <select style="background:red" class="form-control valid" id="city" name="city" required="">
                            ...
                            <div class="form-group">
                                <input style="background:red" type="text" class="form-control" name="district" id="district"
                                       placeholder="District" data-rule="minlen:4"
                                       data-msg="Please enter at least 8 chars of subject">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <input style="background:red" type="text" class="form-control" name="state" id="state" placeholder="State"
                                       data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <input style="background:red" type="text" class="form-control" name="country" id="country"
                            ...
                            <div class="form-group">
                                ...
                                <input style="background:red" type="text" class="form-control" name="company_organization"
                                       id="company_organization" placeholder="Company/Organization" data-rule="minlen:4"
                                       data-msg="Please enter at least 8 chars of subject">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <input style="background:red" type="text" class="form-control" name="background_field_of_study"
                                       id="background_field_of_study" placeholder="Background Field of Study"
                                       data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <input style="background:red" type="text" class="form-control" name="qualification" id="qualification"
                                       placeholder="Qualification" data-rule="minlen:4"
                                       data-msg="Please enter at least 8 chars of subject">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <input style="background:red" type="text" class="form-control" name="web" id="web" placeholder="Web"
                                       data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject">
                                <div class="validation"></div>
                            </div>

                            <div class="form-group">
                                <input style="background:red" type="text" class="form-control" name="university" id="university"
                                       placeholder="University" data-rule="minlen:4"
                                       data-msg="Please enter at least 8 chars of subject">
                                <div class="validation"></div>
                            </div>
                            <div class="form-group">
                                <textarea style="background:red" name="general_info" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <select style="background:red" class="form-control valid select2" name="langs[]" required multiple>
