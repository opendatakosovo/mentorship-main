...
Route::post('update_client_file', 'ApplicationsController@update_client_file');
...
Route::post('update_cv', 'ApplicationsController@admin_update_cv');

Route::post('user/application/store', 'ApplicationsController@application_store');

Route::post('user/application/store_certificates/{id}', 'ApplicationsController@store_certificates');
Route::post('update_client_file/{id}','ApplicationsController@update_client_file' );
